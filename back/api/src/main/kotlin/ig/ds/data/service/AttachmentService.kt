...
class AttachmentService @Inject constructor(
    ...
    fun addFile(fileName: String, fileSize: Long, fileContentStream: InputStream): File {
        val fileInfo = File(
    ...
    fun addAttachment(user: User, attachment: Attachment): String {
    ...
    fun addSignature(user: User, signature: Signature): String {
